...
//     e.preventDefault();
//     if (!form.agree) {
//       setStatus("⚠️ Подтверди согласие с условиями");
//       return;
//     }
...
//     const regex = /^[А-Яа-яЁё\sA-Za-z]{2,}$/;
...
//             <h2 className={styles.title}>{lang === "ru" ? "Стань водителем такси в Кыргызстане" : "Кыргызстанда такси айдоочусу бол"}</h2>
//             <p className={styles.subtitle}>{lang === "ru" ? "*обязательные поля для заполнения" : "*толукталуучу милдеттүү талаалар"}</p>
//             <form onSubmit={handleSubmit} className={styles.form}>
//               <label className={styles.label}>
//                 {lang === "ru" ? "*ФИО" : "*АТЫ ЖӨНҮ"}
//                 <input
//                   type="text"
//                   placeholder={lang === "ru" ? "Введите вашу фамилию, имя и отчество" : "Фамилияңызды, атыңызды киргизиңиз"}
//                   value={form.name}
...
//                   >
//                     <option value="">{lang === "ru" ? "Такси или доставка" : "Такси же жеткирүү"}</option>
//                     <option value="Такси">Такси</option>
//                     <option value="Доставка">{lang === "ru" ? "Доставка" : "Жеткирүү"}</option>
//                   </select>
//                 </label>
//               </div>
...
//                     {lang === "ru" ? "условиями использования" : "мен макулмун"}
//                   </a>
//                 </span>
//               </label>
//               <button type="submit" className={styles.button} disabled={loading}>
//                 {loading ? "Отправка..." : `${lang === "ru" ? "Отправить заявку" : "Өтүнмөнү жиберүү"}`}
//               </button>
